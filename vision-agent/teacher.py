...
def build_greeting(language_name: str | None = None, lesson_title: str | None = None) -> str:
    ...
    if lesson_title:
        return (
            ...
            "Keep it to 1-2 conversational sentences with contractions. Introduce a target word slowly with its translation, and end by gently asking the student to repeat it."
        )
    return (
